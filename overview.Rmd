...
geschlecht$difference_rounded <- round(geschlecht$difference, digits = 3)
...
map_allages <- ggplot(data = landkreisen_fortified_geschlecht,
       aes(long, lat, fill = difference_rounded, group = group, text = paste("<b>", Kreise, "</b>", "<br>","M-F Difference (%):", difference_rounded))) +
...
map_1835_breaks <- ggplot(data = landkreisen_fortified_age,
       aes(long, lat, fill = brks, group = group, text = paste("<b>", Kreise, "</b>", "<br>","M-F Difference (%):", difference_rounded))) +
